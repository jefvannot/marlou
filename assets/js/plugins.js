...
/* Polyfill: iOS VH Bug - Viewport-units-buggyfill v0.3.1 @web: https://github.com/rodneyrehm/viewport-units-buggyfill/ @author: Rodney Rehm - http://rodneyrehm.de/en */
...
/* Polyfill - FastClick: polyfill to remove click delays on browsers with touch UIs. @version 1.0.3 @codingstandard ftlabs-jsv2 @copyright The Financial Times Limited [All Rights Reserved] @license MIT License */
...
/* jQuery.naturalWidth / jQuery.naturalHeight plugin for (already-loaded) images - Triple-licensed: Public Domain, MIT and WTFPL license - share and enjoy! */
(function($) {
  function img(url) {
    var i = new Image;
    i.src = url;
...
/* willFillParent.js - Take an image and stretch it to fill parent MIT license Dependencies: naturalWidth/height: https://gist.github.com/johan/2209957 / imagesLoaded: https://github.com/desandro/imagesloaded */
(function($){
    ...
    $(this).each(function(){
      ...
      if($img.data('willloaded')) {
        ...
        $img.imagesLoaded(function(){
          ...
          $img.data('nw', $img.naturalWidth()).data('nh', $img.naturalHeight())
          .data('nr', $img.data('nw') / $img.data('nh'))
          .data('willloaded', true).addClass('is-loaded').willFillParent(); // no need for params after initial setup
          $img.data('fillcont').find('.loading').fadeOut(250, function(){ $(this).remove(); });
        });
      }
    });
...
/* Slidebars - V 0.10.2 - http://plugins.adchsm.me/slidebars */
;(function($) {
	...
	$.slidebars = function(options) {
		...
		function css() {
			...
			if ($left && ($left.hasClass('sb-style-push') || $left.hasClass('sb-style-overlay'))) $left.css('marginLeft', '-50%');
			if ($right && ($right.hasClass('sb-style-push') || $right.hasClass('sb-style-overlay'))) $right.css('marginRight', '-50%');
...
function masonryDefinition( Outlayer, getSize ) {
  ...
  Masonry.prototype._getItemLayoutPosition = function( item ) {
    ...
    var mathMethod = remainder && remainder < 2 ? 'round' : 'ceil';
...
/* headroom.js v0.7.0 - Give your page some headroom. Hide your header until you need it Copyright (c) 2014 Nick Williams - http://wicky.nillia.ms/headroom.js License: MIT */
